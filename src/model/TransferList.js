...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MediaShuttleApi.TransferList = factory(root.MediaShuttleApi.ApiClient, root.MediaShuttleApi.Transfer);
  }
}(this, function(ApiClient, Transfer) {
  'use strict';

  /**
   * The TransferList model module.
   * @module model/TransferList
   * @version 1.13.3
   */

  /**
   * Constructs a new <code>TransferList</code>.
   * Response from listing transfers.
   * @alias module:model/TransferList
   * @class
   */
  ...
  /**
   * Constructs a <code>TransferList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransferList} obj Optional instance to populate.
   * @return {module:model/TransferList} The populated <code>TransferList</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('items'))
        obj.items = ApiClient.convertToType(data['items'], [Transfer]);
    }
    return obj;
  }

  /**
   * @member {Array.<module:model/Transfer>} items
   */
