...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Portal'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Portal'));
  } else {
    // Browser globals (root is window)
    if (!root.MediaShuttleApi) {
      root.MediaShuttleApi = {};
    }
    root.MediaShuttleApi.PortalList = factory(root.MediaShuttleApi.ApiClient, root.MediaShuttleApi.Portal);
  }
}(this, function(ApiClient, Portal) {
  'use strict';

  /**
   * The PortalList model module.
   * @module model/PortalList
   * @version 1.13.3
   */

  /**
   * Constructs a new <code>PortalList</code>.
   * Response from listing portals.
   * @alias module:model/PortalList
   * @class
   */
  ...
  /**
   * Constructs a <code>PortalList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortalList} obj Optional instance to populate.
   * @return {module:model/PortalList} The populated <code>PortalList</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('items'))
        obj.items = ApiClient.convertToType(data['items'], [Portal]);
    }
    return obj;
  }

  /**
   * @member {Array.<module:model/Portal>} items
   */
