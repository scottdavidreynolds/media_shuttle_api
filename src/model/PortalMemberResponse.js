...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MediaShuttleApi.PortalMemberResponse = factory(root.MediaShuttleApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PortalMemberResponse model module.
   * @module model/PortalMemberResponse
   * @version 1.13.3
   */

  /**
   * Constructs a new <code>PortalMemberResponse</code>.
   * @alias module:model/PortalMemberResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PortalMemberResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortalMemberResponse} obj Optional instance to populate.
   * @return {module:model/PortalMemberResponse} The populated <code>PortalMemberResponse</code> instance.
   */
