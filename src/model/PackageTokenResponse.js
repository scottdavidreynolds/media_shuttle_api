...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MediaShuttleApi.PackageTokenResponse = factory(root.MediaShuttleApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PackageTokenResponse model module.
   * @module model/PackageTokenResponse
   * @version 1.13.3
   */

  /**
   * Constructs a new <code>PackageTokenResponse</code>.
   * @alias module:model/PackageTokenResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PackageTokenResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PackageTokenResponse} obj Optional instance to populate.
   * @return {module:model/PackageTokenResponse} The populated <code>PackageTokenResponse</code> instance.
   */
  ...
  /**
   * The URL that the user should navigate to in order to perform the transfer.
   * @member {String} url
   */
   ...
   * @member {Array.<module:model/PackageTokenResponse.GrantsEnum>} grants
   */
