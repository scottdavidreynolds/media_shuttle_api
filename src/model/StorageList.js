...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MediaShuttleApi.StorageList = factory(root.MediaShuttleApi.ApiClient, root.MediaShuttleApi.Storage);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items'))
        obj.items = ApiClient.convertToType(data['items'], [Storage]);
    }
    return obj;
  }

  /**
   * @member {Array.<module:model/Storage>} items
   */
