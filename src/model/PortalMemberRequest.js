...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PortalMemberResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PortalMemberResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.MediaShuttleApi) {
      root.MediaShuttleApi = {};
    }
    root.MediaShuttleApi.PortalMemberRequest = factory(root.MediaShuttleApi.ApiClient, root.MediaShuttleApi.PortalMemberResponse);
  }
}(this, function(ApiClient, PortalMemberResponse) {
  'use strict';

  /**
   * The PortalMemberRequest model module.
   * @module model/PortalMemberRequest
   * @version 1.13.3
   */

  /**
   * Constructs a new <code>PortalMemberRequest</code>.
   * An object representing user membership on the portal
   * @alias module:model/PortalMemberRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>PortalMemberRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortalMemberRequest} obj Optional instance to populate.
   * @return {module:model/PortalMemberRequest} The populated <code>PortalMemberRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('items'))
        obj.items = ApiClient.convertToType(data['items'], [PortalMemberResponse]);
  ...
  /**
   * @member {Array.<module:model/PortalMemberResponse>} items
   */
