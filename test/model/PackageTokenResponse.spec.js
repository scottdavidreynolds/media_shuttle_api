...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PackageTokenResponse', function() {
      beforeEach(function() {
        instance = new MediaShuttleApi.PackageTokenResponse();
      });

      it('should create an instance of PackageTokenResponse', function() {
        // TODO: update the code to test PackageTokenResponse
        expect(instance).to.be.a(MediaShuttleApi.PackageTokenResponse);
      });
