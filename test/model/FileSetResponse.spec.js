...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FileSetResponse', function() {
      beforeEach(function() {
        instance = new MediaShuttleApi.FileSetResponse();
      });

      it('should create an instance of FileSetResponse', function() {
        // TODO: update the code to test FileSetResponse
        expect(instance).to.be.a(MediaShuttleApi.FileSetResponse);
      });
