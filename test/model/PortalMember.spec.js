...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortalMember', function() {
      beforeEach(function() {
        instance = new MediaShuttleApi.PortalMember();
      });

      it('should create an instance of PortalMember', function() {
        // TODO: update the code to test PortalMember
        expect(instance).to.be.a(MediaShuttleApi.PortalMember);
      });
      ...
      it('should have the property portalPermissions (base name: "portalPermissions")', function() {
        // TODO: update the code to test the property portalPermissions
        expect(instance).to.have.property('portalPermissions');
        // expect(instance.portalPermissions).to.be(expectedValueLiteral);
      });
