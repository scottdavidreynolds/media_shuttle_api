...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortalSubscriptionResponse', function() {
      beforeEach(function() {
        instance = new MediaShuttleApi.PortalSubscriptionResponse();
      });

      it('should create an instance of PortalSubscriptionResponse', function() {
        // TODO: update the code to test PortalSubscriptionResponse
        expect(instance).to.be.a(MediaShuttleApi.PortalSubscriptionResponse);
      });
