...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransferList', function() {
      beforeEach(function() {
        instance = new MediaShuttleApi.TransferList();
      });

      it('should create an instance of TransferList', function() {
        // TODO: update the code to test TransferList
        expect(instance).to.be.a(MediaShuttleApi.TransferList);
      });
