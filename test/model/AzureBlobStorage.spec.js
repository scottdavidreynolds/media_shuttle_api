...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AzureBlobStorage', function() {
      beforeEach(function() {
        instance = new MediaShuttleApi.AzureBlobStorage();
      });

      it('should create an instance of AzureBlobStorage', function() {
        // TODO: update the code to test AzureBlobStorage
        expect(instance).to.be.a(MediaShuttleApi.AzureBlobStorage);
      });
