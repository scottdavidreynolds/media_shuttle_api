...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortalStorageList', function() {
      beforeEach(function() {
        instance = new MediaShuttleApi.PortalStorageList();
      });

      it('should create an instance of PortalStorageList', function() {
        // TODO: update the code to test PortalStorageList
        expect(instance).to.be.a(MediaShuttleApi.PortalStorageList);
      });
