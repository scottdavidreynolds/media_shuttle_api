...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PackageEventSetResponse', function() {
      beforeEach(function() {
        instance = new MediaShuttleApi.PackageEventSetResponse();
      });

      it('should create an instance of PackageEventSetResponse', function() {
        // TODO: update the code to test PackageEventSetResponse
        expect(instance).to.be.a(MediaShuttleApi.PackageEventSetResponse);
      });
