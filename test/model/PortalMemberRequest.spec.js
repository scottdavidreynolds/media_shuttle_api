...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortalMemberRequest', function() {
      beforeEach(function() {
        instance = new MediaShuttleApi.PortalMemberRequest();
      });

      it('should create an instance of PortalMemberRequest', function() {
        // TODO: update the code to test PortalMemberRequest
        expect(instance).to.be.a(MediaShuttleApi.PortalMemberRequest);
      });
