...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortalMemberResponse', function() {
      beforeEach(function() {
        instance = new MediaShuttleApi.PortalMemberResponse();
      });

      it('should create an instance of PortalMemberResponse', function() {
        // TODO: update the code to test PortalMemberResponse
        expect(instance).to.be.a(MediaShuttleApi.PortalMemberResponse);
      });
